# ─────────────────────────────────────────────────────────────────────────────
# Architecture Recommendations — Opt-in Toggles
#
# Enable any combination of these best-practice additions.
# All default to false — set to true in terraform.tfvars or via TF_VAR_*.
#
# Full analysis: /ARCHITECTURE-ANALYSIS.md
# Module source: /blueprints/modules/recommendations/
# ─────────────────────────────────────────────────────────────────────────────
